...
/**
 * OG-Bild für `/plattform/so-arbeitet-golfnext` (Masterplan 6.2). Der Titel kommt aus
...
export const alt = routeTitle("/plattform/so-arbeitet-golfnext");

export default async function Bild() {
  return ogBild({ titel: routeTitle("/plattform/so-arbeitet-golfnext") });
}
