...
import type { StoryLink, StoryStep } from "@/content/plattform";
import { StoryDeviceView } from "./StoryDeviceView";
import styles from "./Story.module.css";

/**
 * 4 · Scroll-Geschichte (portiert aus 3.2c .story/.stps/.stp/.stage/.panel).
 * Links fünf Schritte, rechts ein klebender Geräterahmen; der aktive Schritt steuert
 * das Bild im Rahmen (IntersectionObserver, Muster aus dem Mock).
 *
 ...
 */
export function ScrollStory({ steps, links }: { steps: StoryStep[]; links: StoryLink[] }) {
          ...
          {steps.map((s, i) => (
            ...
            >
              ...
              <div className={styles.mob} aria-hidden="true">
                <StoryDeviceView device={s.device} />
              </div>
            </div>
          ))}
        </div>
