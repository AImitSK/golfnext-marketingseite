...
- [ ] **3.9 Artikel-Teaser aus Sanity** (Briefing 0029). Die Teaser auf der Startseite (Abschnitt 8 „Praxis") und im Wissen-Slider auf `/ueber-golfnext` stehen noch als statische Daten im Repo – auf der Startseite mit **vollständigen Titeln, Autoren, Daten und Lesezeiten von Artikeln, die es nicht gibt** (aus Mock 3.1b übernommen). Beide Blöcke lesen künftig die neuesten Artikel aus Sanity und verlinken auf `/praxis/<slug>`; die Optik bleibt unverändert. Auch der Wissen-Slider kommt vollständig aus Sanity: Stefan hat am 08.09.2026 die Rubrik **„Fachartikel"** angelegt, Freds Fachzeitschriften-Beiträge sind damit normale Artikel. Kein Rubrik-Filter, gesteuert wird über das Veröffentlichungsdatum. Ohne Artikel entfallen beide Abschnitte vollständig.
